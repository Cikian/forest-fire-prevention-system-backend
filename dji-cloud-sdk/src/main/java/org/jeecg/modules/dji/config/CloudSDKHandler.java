package org.jeecg.modules.dji.config;
...
public class CloudSDKHandler {
    ...
    @Before("execution(public * org.jeecg.modules.dji.cloudapi.*.api.*.*(org.jeecg.modules.dji.config.version.GatewayManager, ..))")
    ...
    @Before("execution(public * org.jeecg.modules.dji.cloudapi.*.api.*.*(org.jeecg.modules.dji.config.version.GatewayManager, org.jeecg.modules.dji.common.BaseModel+))")
    public void checkRequest(JoinPoint point) {
        Common.validateModel((BaseModel) point.getArgs()[1], (GatewayManager) point.getArgs()[0]);
    }

    @AfterReturning(value = "execution(public org.jeecg.modules.dji.common.HttpResultResponse+ org.jeecg.modules.dji.cloudapi.*.api.*.*(..))", returning = "response")
